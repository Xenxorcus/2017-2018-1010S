...
#pragma config(Motor,  port4,           RLift,         tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           LLift,         tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           RBack,         tmotorVex393HighSpeed_MC29, openLoop, reversed)
