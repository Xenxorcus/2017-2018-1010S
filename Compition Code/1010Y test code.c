#pragma config(Motor,  port2,           RFront,        tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           LFront,        tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           RLift,         tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           LLift,         tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           RBack,         tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           LBack,         tmotorVex393HighSpeed_MC29, openLoop)
